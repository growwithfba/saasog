      ...
      <div className="max-w-3xl mx-auto py-8 px-4 sm:px-6">
        ...
        <article className="max-w-none">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">1. Eligibility</h2>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4. Subscription &amp; Payments</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">6. Data &amp; Third-Party Integrations</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">7. Intellectual Property</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">8. Beta Disclaimer</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">9. Disclaimer of Warranties</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">12. Governing Law</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">13. Changes to These Terms</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">14. Contact</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">

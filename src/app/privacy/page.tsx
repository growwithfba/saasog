      ...
      <div className="max-w-3xl mx-auto py-8 px-4 sm:px-6">
        ...
        <article className="max-w-none">
          <header className="mb-12">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">Last Updated: Feb 10, 2026</p>
          </header>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">1. Information We Collect</h2>

            <h3 className="text-lg font-medium text-slate-800 dark:text-slate-200 mb-3 mt-6">A. Information You Provide</h3>
            ...
            <h3 className="text-lg font-medium text-slate-800 dark:text-slate-200 mb-3 mt-6">B. Automatically Collected Information</h3>
            <ul className="list-disc pl-6 text-slate-700 dark:text-slate-300 space-y-2 mb-4">
              <li>IP address</li>
            ...
            <h3 className="text-lg font-medium text-slate-800 dark:text-slate-200 mb-3 mt-6">C. Third-Party Data</h3>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">2. How We Use Your Information</h2>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">3. Data Storage &amp; Security</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4. Data Retention</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">5. Cookies &amp; Tracking</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">6. Third-Party Services</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">7. Your Rights</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">9. International Users</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">10. Changes to This Policy</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">11. Contact</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
        ...
        {/* Footer links */}
        <div className="flex flex-wrap gap-4 pt-8 border-t border-[#1e3a8a]/[0.12] dark:border-slate-700">
          <Link
            href="/terms"

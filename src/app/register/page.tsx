          ...
          <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-16">
            <div className="max-w-lg">
              ...
              <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
                Start Your FBA Private Label Journey with 
                <span className="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent"> AI-Powered </span>
                Validation
              </h2>
              
              <p className="text-xl text-slate-300 mb-12 leading-relaxed">
                Find, validate, and improve winning product opportunities with a proven system trusted by 7-figure sellers worldwide — so you can launch and scale your brand with confidence.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">Validate Faster</h3>
                    <p className="text-slate-400">Instantly filter out bad ideas and focus only on products worth launching</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">Data You Can Trust</h3>
                    <p className="text-slate-400">Make smarter decisions with AI-powered insights grounded in real market data</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">Products That Win</h3>
                    <p className="text-slate-400">Design offers built to dominate your niche</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">Grow Your Freedom</h3>
                    <p className="text-slate-400">Build a business that supports the life you actually want to live</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-md">
              ...
              <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-2">Start Your Brand Journey</h2>
                  <p className="text-slate-400">Start validating profitable product opportunities today.</p>
                </div>

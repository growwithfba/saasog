...
export const LEARN_VIDEOS: Record<LearnSection, LearnVideo[]> = {
  ...
  'vetting-detail': [
    ...
    },
    {
      ...
      description: 'Market Signals provide a deeper view of long-term competitor behavior. In this video you’ll learn how BloomEngine analyzes your top competitors’ sales and pricing trends over the past two years to help you evaluate market stability and opportunity.',
    },
  ],
  offering: [
    {

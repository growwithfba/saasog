...
export const LEARN_VIDEOS: Record<LearnSection, LearnVideo[]> = {
  ...
  offering: [
    ...
    {
      id: 'ssp-builder',
      label: 'Using the USP Builder Hub',
      icon: Package,
      embedId: '9cd03891ed84432eb8bc757d5367506e',
      title: 'Using the USP Builder Hub',
      description: 'Now that you understand the market gaps, it\u2019s time to turn them into real competitive advantages. In this video you\u2019ll learn how to use the USP Builder Hub to create powerful Unique Selling Points (USPs) that differentiate your product and position your offer to win in the marketplace',

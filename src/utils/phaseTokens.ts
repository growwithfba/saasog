...
export const phaseTokens: Record<PhaseType, PhaseTokenConfig> = {
  ...
  sourcing: {
    ...
    borderColorActive: 'border-teal-500/70',
    borderWidth: 'border',
    borderWidthActive: 'border-2',
    shadowColor: 'shadow-lg shadow-teal-500/15',
    shadowColorActive: 'shadow-xl shadow-teal-500/25',
    shadowColorHover: 'hover:shadow-xl hover:shadow-teal-500/25',
    glowColor: 'bg-teal-500/10',
    glowColorActive: 'bg-teal-500/15',
    textColor: 'text-teal-300',
    textColorActive: 'text-teal-200',
    ringColor: 'ring-teal-500/40',
    ringColorActive: 'ring-teal-500/60',
  },
};

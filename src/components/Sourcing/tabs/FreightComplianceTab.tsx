  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="bg-white dark:bg-slate-800/50 rounded-xl border border-[#1e3a8a]/[0.12] dark:border-slate-700/50 p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Incoterms</label>
              <input
                type="text"
                value={freightData.incoterms || ''}
                onChange={(e) => handleFieldChange('incoterms', e.target.value)}
                placeholder="e.g., EXW, FOB, CIF, DDP"
                className="w-full px-3 py-2 bg-[#f5f8fd] dark:bg-slate-900/50 border border-[#1e3a8a]/[0.12] dark:border-slate-700/50 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500/50"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Freight Forwarder</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">HTS Lookup URL</label>
              <input
                type="url"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Duty Rate %</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Tariff %</label>
                <input
                  type="number"
                  step="0.01"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 bg-[#f5f8fd] dark:bg-slate-900/50 border border-[#1e3a8a]/[0.12] dark:border-slate-700/50 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500/50 resize-none"
              />
            </div>
          </div>
        </div>
      ...
      <div className="lg:col-span-1">
        <div className="bg-white dark:bg-slate-800/50 rounded-xl border border-[#1e3a8a]/[0.12] dark:border-slate-700/50 p-6 sticky top-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Order Readiness Checklist</h3>
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg hover:bg-[#eef2f9] dark:hover:bg-slate-700/30 transition-colors">
              <Checkbox
              ...
              <div className="flex-1">
                <div className="text-slate-900 dark:text-white font-medium">HTS Confirmed</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">HTS code has been verified and confirmed</div>
              </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg hover:bg-[#eef2f9] dark:hover:bg-slate-700/30 transition-colors">
              ...
              />
              <div className="flex-1">
                <div className="text-slate-900 dark:text-white font-medium">Incoterms Agreed</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Incoterms have been agreed upon with supplier</div>
              </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg hover:bg-[#eef2f9] dark:hover:bg-slate-700/30 transition-colors">
              ...
              />
              <div className="flex-1">
                <div className="text-slate-900 dark:text-white font-medium">Freight Quote Received</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Freight forwarder has provided a quote</div>
              </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg hover:bg-[#eef2f9] dark:hover:bg-slate-700/30 transition-colors">
              ...
              />
              <div className="flex-1">
                <div className="text-slate-900 dark:text-white font-medium">Inspection Plan Set</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Quality inspection plan has been established</div>
              </div>
          ...
          {/* Progress Summary */}
          <div className="mt-6 pt-6 border-t border-[#1e3a8a]/[0.12] dark:border-slate-700/50">
            ...
            <div className="w-full h-2 bg-[#eef2f9] dark:bg-slate-700/50 rounded-full overflow-hidden">
              <div

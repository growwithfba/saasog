...
export function SourcingGlobalActions({ onSave, onClear, onMarkAsSourced, hasData }: SourcingGlobalActionsProps) {
    ...
    <>
      <div className="bg-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            onClick={handleMarkAsSourced}
            disabled={!hasData}
            className="px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-white font-medium transition-all transform hover:scale-105 flex items-center gap-2"
          >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-xl p-6 max-w-md w-full border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white">Clear all Sourcing data for this product?</h3>
                <p className="text-slate-400 text-sm">This action cannot be undone</p>
              </div>
            </div>
            
            <p className="text-slate-300 mb-6">
              This will remove all supplier quotes, profit calculations, freight information, and packaging specs for this product.
            </p>

...
export const ImprovedCsvUpload: React.FC<CsvUploadProps> = ({ onSubmit, userId }) => {
  ...
  const normalizeColumnNames = useCallback((data: any[]): any[] => {
    ...
    const columnMapping: Record<string, string> = {
      ...
      'sellercount': 'Active Sellers',
      'numberofsellers': 'Active Sellers',
      'noofsellers': 'Active Sellers',
      'brandname': 'Brand',
      'manufacturer': 'Brand',
    ...
    try {
      ...
      const processedCompetitors = csvData.map(row => {
        ...
        return {
          ...
          // sellerCount and activeSellers resolve to the same underlying
          // H10 field ("Number of Sellers" / "Seller Count" / "Sellers" /
          // "Active Sellers"). All variants normalize to 'Active Sellers'
          // via columnMapping; both display columns read from there.
          sellerCount: cleanNumber(row['Active Sellers'] || 0),
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-2">
          <div className="flex items-center gap-3">
            <img
              src="/GWF7.png"
              alt="Market Analysis Calculator Logo"

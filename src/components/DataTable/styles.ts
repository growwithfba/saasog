...
export const HEAD_ROW = 'border-b border-gray-200 dark:border-slate-700';

/** Every header cell, pinned or not. Sticky to the top of the scroll box. */
export const HEAD_CELL =
  'sticky top-0 z-20 bg-white dark:bg-slate-900 select-none py-3 text-left align-middle font-semibold uppercase tracking-wide text-[11px] leading-tight text-gray-500 dark:text-slate-400';
...
export const ROW = 'group/row border-b border-gray-100 dark:border-slate-800 transition-colors';
...
export const CELL =
  'px-3 py-3 align-middle border-r border-gray-100 dark:border-slate-800/60 text-gray-700 dark:text-slate-300';

/** The rule between the pinned block and the scrolling columns is a touch
 *  stronger so the boundary reads while scrolling. */
export const CELL_PINNED_EDGE = 'border-r border-gray-200 dark:border-slate-700';
 ...
 * flattened onto the card: white / slate-900, the blue-500 selection wash, and

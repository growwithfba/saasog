...
const SECTION_COLORS: Record<Section, SectionColors> = {
  ...
  sourcing: {
    ...
    gradientHover: 'hover:from-teal-800 hover:to-teal-700',
    iconBg: 'bg-teal-600/15',
    iconText: 'text-teal-500',
    iconShadow: 'shadow-lg shadow-teal-600/25',
    containerBorder: 'border-teal-600/30',
    containerShadow: 'shadow-2xl shadow-teal-600/10',
    headerDivider: 'border-teal-600/15',
    glowBlob: 'bg-teal-700',
    tabActiveShadow: 'shadow-md shadow-teal-600/25',
    tabActiveBorder: 'border border-teal-600/40',
    ctaBg: 'from-teal-700/10 to-teal-600/10',
    ctaBorder: 'border-teal-600/20',
  },
};

...
const INPUT_CLASS = field('research');
    ...
    <div className={PANEL_PAD}>
      <div className="flex flex-wrap items-center gap-2 mb-6">
        ...
        <button
          type="button"
          onClick={onCollapse}
          className={`ml-auto shrink-0 ${TERTIARY_BUTTON}`}
        >
      ...
      <div className="mb-10">
        <SectionHeading phase="research">Category &amp; Subcategory</SectionHeading>
        <CategoryPicker
        ...
        {COLUMNS.map((groupKeys, colIndex) => (
          <div key={colIndex} className="space-y-10">
            {groupKeys.map((groupKey) => {
              ...
              return (
          <div key={group.key}>
            <SectionHeading phase="research">{group.title}</SectionHeading>
              ...
              {group.key === 'listing' && (
                <div>
                  ...
                  <SizeTierPicker
                    ...
                    className={fieldButton('research')}
                  />
                </div>
              )}
      ...
      <div className="flex items-center justify-end gap-3 mt-6">
        ...
        <button
          ...
          className={secondaryButton('research')}
        >
          Clear
        </button>
        <button
          ...
          disabled={searching}
          className={primaryButton('research')}
        >
